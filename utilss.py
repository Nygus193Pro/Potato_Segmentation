...
class_names = ['ziemniak', 'bez lupiny', 'pekniecie', 'ksztalt', 'pomarszczony', 'kielkujacy', 'zaschniete', 'przeciety']
...
def draw_masks(image, boxes, class_ids, mask_alpha=0.3, mask_maps=None):
    ...
    for i, (box, class_id) in enumerate(zip(boxes, class_ids)):
        ...
        if mask_maps is None:
            ...
            blue_color = np.array([255, 0, 0], dtype=np.uint8)  # BGR: niebieski
